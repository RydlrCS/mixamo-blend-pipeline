...
def log_function_call(func: F) -> F:
    ...
    Example:
        ...
        >>> 
        >>> # Output:
        >>> # 2026-01-04 10:30:15 - module - INFO - ENTER download_animation(url='...', output_path='...')
        >>> # 2026-01-04 10:30:16 - module - INFO - EXIT download_animation -> True (1.2s)
    """
    ...
    def wrapper(*args: Any, **kwargs: Any) -> Any:
        ...
        try:
            ...
            logger.info(
                f"EXIT {func.__name__} -> {repr(result)} ({execution_time:.2f}s)"
            )
